...
The list of programmes present in this folder full of programmes are :

**Part A**: Conditional Statements
1. Check whether a number is positive, negative, or zero – determines the nature of a number based on its value.
2. Check whether a number is even or odd – identifies divisibility of a number by 2.
3. Find the largest of two numbers – compares two inputs to determine the greater value.
4. Find the largest of three numbers – uses nested conditions to identify the maximum among three values.
5. Display grade based on marks – assigns grades according to predefined score ranges.
6. Menu-driven calculator – performs basic arithmetic operations based on user choice.


**Part B:** Loops (for and while)
7. Print numbers from 1 to 10 – demonstrates iteration using a for loop.
8. Print even numbers from 1 to 20 – filters and displays even values within a range.
9. Find sum of first 10 natural numbers – calculates cumulative total using iteration.
10. Display multiplication table – generates multiples of a number in a structured format.
11. Print numbers from 1 to 5 – uses a while loop for controlled iteration.
12. Calculate sum from 1 to n – computes sum dynamically based on user input.
13. Take input until user enters 0 – demonstrates indefinite looping with a stopping condition.


**Part C:** Break and Continue
14. Print numbers and stop at 6 – uses break to terminate loop execution early.
15. Print numbers and skip 5 – uses continue to skip a specific iteration.
16. Search for a number in a list – stops searching once the target value is found.


**Part D:** Functions
17. Print “Hello, World!” – demonstrates basic function definition and calling.
18. Return square of a number – computes and returns the square of a value.
19. Add two numbers – performs addition using a reusable function.
20. Check even or odd – determines number type using a function.
21. Calculate factorial – computes factorial using iterative or functional logic.
22. Print multiplication table – generates a table using a function for reuse.


**Part E:** Integrated Programs
23. Print numbers and identify even/odd – combines loops and functions for classification.
24. Menu-driven calculator with loop – repeatedly performs operations until the user exits.
